...
This study presents a reproducible framework for diagnosing temporal conditioning in deep learning-based rainfall nowcasting, focusing on forecast skill, explainability, robustness across rainfall regimes, and computational efficiency.
...
- **Forecasting strategies**:
  - **1-output recursive**: Predict 1 frame at a time recursively (12 steps).
  - **6-output hybrid**: Predict the first 6 frames in one step, then generate 6 more recursively.
  - **12-output direct**: Predict all 12 future frames in one forward pass.
